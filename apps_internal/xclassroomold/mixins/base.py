...
from apps_data.courseevent.models.menu import Menu
...
class AuthMixin(LoginRequiredMixin, UserPassesTestMixin, MessageMixin):
    ...
    def test_func(self, user):
        ...
        """
        courseevent = get_object_or_404(Course, slug=self.kwargs['course_slug'])
...
class ClassroomMenuMixin(AuthMixin):
    ...
    def get_context_data(self, **kwargs):
        ...
        if not 'menu' in context:
            context['menu'] = get_object_or_404(Menu, courseevent=context['courseevent'])
