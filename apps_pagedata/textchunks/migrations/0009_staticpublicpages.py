...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('textchunks', '0008_auto_20151104_1002'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.ImageField(help_text='Optional kann ein Banner hochgeladen werden, dass nach aussen angezeigt werden kann.', upload_to=apps_pagedata.textchunks.models.foto_location, verbose_name='Banner', blank=True)),
