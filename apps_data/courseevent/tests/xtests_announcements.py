...
class LessonAttributesTest(TestCase):
    ...
    def setUp(self):
        ...
        """
        slug1 = "slug1"
        Course.objects.create(title="title1", slug=slug1)
        self.course1 = Course.objects.get(slug=slug1)
        ...
        slug2 = "slug2"
        Course.objects.create(title="title2", slug=slug2)
        self.course2 = Course.objects.get(slug=slug2)
