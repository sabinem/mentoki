...
import apps_data.course.models
from apps_data.course.models.course import foto_location
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=apps_data.course.models.lesson_material_name, verbose_name='Datei', blank=True)),
