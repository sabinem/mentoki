...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('course', '0021_auto_20150902_1224'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='course',
            name='email',
            field=models.EmailField(default='mentoki@mentoki.com', help_text='Die email-Adresse des Kursleiters oder eine Mentoki-Adresse. Bitte\n        stimme diese Adresse mit Mentoki ab.', max_length=254, verbose_name='email Addresse f\xfcr den Kurs'),
        ),
        migrations.AlterField(
