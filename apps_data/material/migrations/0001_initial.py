    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf_download_link', models.BooleanField(default=True, help_text='Es wird ein Download-Link angeboten.', verbose_name='Download-Link anbieten?')),
                ('pdf_viewer', models.BooleanField(default=True, help_text='Bei Dateityp pdf: Das pdf-Datei ist durch einen Pdf-\n        Viewer ind die Webseite integriert, falls das m\xf6glich ist (auf dem PC\n        zum Beispiel).', verbose_name='Pdf-Viewer anbieten?')),
