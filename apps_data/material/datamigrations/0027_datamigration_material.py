...
"""
shell script:
from apps_data.course.models.material import Material as OldMaterial
from apps_data.material.models.material import Material as NewMaterial

materials = OldMaterial.objects.all()
