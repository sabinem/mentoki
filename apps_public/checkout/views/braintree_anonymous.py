...
class AnonymousPaymentView(
    ...
    def get_context_data(self, **kwargs):
        ...
        """
        context = super(AnonymousPaymentView, self).get_context_data(**kwargs)
    ...
    def get_form_kwargs(self):
        ...
        kwargs = super(AnonymousPaymentView, self).get_form_kwargs()
        if not self.request.user.is_authenticated():
            kwargs['user']= user
        return kwargs
    ...
    def form_valid(self, form):
        ...
        return super(AnonymousPaymentView, self).form_valid(form)
